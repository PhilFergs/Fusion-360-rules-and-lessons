...
- PhilsDesignTools-1.0.12.zip
  - Steel member generation + utilities (EA/SHS/RHS, rotate, rename, hole cut, stub arms, exports, preserve-position reparenting, safer profile descriptions).
- PhilsBom.bundle-1.03.zip
  - BOM export add-in (CSV/XLSX/XML/JSON, unit control, include/exclude options, mass totals).
- fusion360-addins-installer-pdt-1.0.12-bom-1.03.zip
  - One-click installer package for both add-ins (PhilsDesignTools + PhilsBom.bundle) with overwrite support.
- fusion360-addins-installer-pdt-1.0.12-bom-1.03.msi
